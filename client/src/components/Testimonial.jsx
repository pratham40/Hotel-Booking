...
function Testimonial() {
  return (
    <div className='flex flex-col items-center px-4 md:px-10 pt-20 pb-30 bg-gray-50 '>
        <Title 
            title="What Our Guests Say"
            subtitle="Hear from our satisfied customers about their experiences with us."
            align="left"
            font="font-playfair"
        />
